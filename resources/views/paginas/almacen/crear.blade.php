            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                        	<form action="{{ url('dashboard/almacen') }}" method="POST">
                        		@csrf
                        		@method('POST')
                        		<div class="form-row">
                        			<div class="col">
                        				<label for="">Nombre del item</label>
                        				<input type="text" required="" class="form-control" name="nombre_equipo" id="nombre_equipo"  >
                        			</div>
                        			<div class="col">
                        		...
                        		<div class="form-row">
                        			<div class="col">
                        				...
                        				<select name="tipo_equipo" id="tipo_equipo" class="form-control" required="">
                        					...
                        					<option value="MATERIAL_MEDICO">MATERIAL MEDICO</option>
                        			...
                        			<div class="col">
                        				...
                        				<select name="fuente_adquisicion" id="fuente_adquisicion" class="form-control" required="">
                        					<option value="">-- SELECCIONE UNO --</option>
                        					<option value="PUBLICA">INSTITUCION PUBLICA</option>
                        					<option value="PRIVADA">EMPRESA PRIVADA</option>
                        					<option value="MIXTA">EMPRESA MIXTA</option>
                        					<option value="INTERNACIONAL">ORIGEN INTERNACIONAL</option>
                        				</select>
                        			</div>
                        			<div class="col">
                        				<label for="">Codigo de documento de adquisicion</label>
                        				<input type="text" name="documento_adquisicion" class="form-control" id="documento_adquisicion">
                        			</div>
                        		</div>
                        		<br>
                        		<div class="form-row">
